...
P.Event.PlotDrawEvent = function(type, feature){
    ol.ObjectEvent.prototype.constructor.call(this,type);
    this.feature = feature;
};

ol.inherits(P.Event.PlotDrawEvent, ol.ObjectEvent);
...
P.Plot.Arc = function(points){
    ol.geom.LineString.prototype.constructor.call(this, []);
    this.type = P.PlotTypes.ARC;
    this.fixPointCount = 3;
    this.setPoints(points);
};

ol.inherits(P.Plot.Arc, ol.geom.LineString);
Object.assign(P.Plot.Arc.prototype, P.Plot.prototype);
...
P.Plot.AttackArrow = function(points){
    ol.geom.Polygon.prototype.constructor.call(this, []);    
...
ol.inherits(P.Plot.AttackArrow, ol.geom.Polygon);
Object.assign(P.Plot.AttackArrow.prototype, P.Plot.prototype);
...
P.Plot.SquadCombat = function(points){
    P.Plot.AttackArrow.prototype.constructor.call(this, []);  
...
ol.inherits(P.Plot.SquadCombat, P.Plot.AttackArrow);
...
ol.inherits(P.Plot.TailedAttackArrow, P.Plot.AttackArrow);
...
ol.inherits(P.Plot.TailedSquadCombat, P.Plot.AttackArrow);
...
ol.inherits(P.Plot.Circle, ol.geom.Polygon);
Object.assign(P.Plot.Circle.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.ClosedCurve, ol.geom.Polygon);
Object.assign(P.Plot.ClosedCurve.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.Curve, ol.geom.LineString);
Object.assign(P.Plot.Curve.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.DoubleArrow, ol.geom.Polygon);
Object.assign(P.Plot.DoubleArrow.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.Ellipse, ol.geom.Polygon);
Object.assign(P.Plot.Ellipse.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.FineArrow, ol.geom.Polygon);
Object.assign(P.Plot.FineArrow.prototype, P.Plot.prototype);
...
P.Plot.AssaultDirection = function(points){
    P.Plot.FineArrow.prototype.constructor.call(this, []);  
...
ol.inherits(P.Plot.AssaultDirection, P.Plot.FineArrow);
...
ol.inherits(P.Plot.GatheringPlace, ol.geom.Polygon);
Object.assign(P.Plot.GatheringPlace.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.Lune, ol.geom.Polygon);
Object.assign(P.Plot.Lune.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.Sector, ol.geom.Polygon);
Object.assign(P.Plot.Sector.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.StraightArrow, ol.geom.LineString);
Object.assign(P.Plot.StraightArrow.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.Polyline, ol.geom.LineString);
Object.assign(P.Plot.Polyline.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.FreehandLine, ol.geom.LineString);
Object.assign(P.Plot.FreehandLine.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.Polygon, ol.geom.Polygon);
Object.assign(P.Plot.Polygon.prototype, P.Plot.prototype);
...
P.Plot.Marker = function(points){
    ol.geom.Point.prototype.constructor.call(this, [0, 0]);  
...
ol.inherits(P.Plot.Marker, ol.geom.Point);
Object.assign(P.Plot.Marker.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.Rectangle, ol.geom.Polygon);
Object.assign(P.Plot.Rectangle.prototype, P.Plot.prototype);
...
ol.inherits(P.Plot.FreehandPolygon, ol.geom.Polygon);
Object.assign(P.Plot.FreehandPolygon.prototype, P.Plot.prototype);
...
P.PlotDraw = function(map, style){
    ol.Observable.prototype.constructor.call(this, []);  
...
ol.inherits(P.PlotDraw, ol.Observable);
...
P.PlotDraw.prototype.mapFirstClickHandler = function (e) {
    ...
    ol.Observable.prototype.on.call(this.mapViewport, P.Event.EventType.MOUSEMOVE,
...
P.PlotDraw.prototype.mapMouseMoveHandler = function (e) {
    ...
    //     return;
    var lastPixel = this.map.getPixelFromCoordinate(this.points[this.points.length - 1]);
    if (P.PlotUtils.distance(lastPixel, [e.offsetX, e.offsetY]) < 0.5){
        return;
    }
...
P.PlotDraw.prototype.disconnectEventHandlers = function () {
    ...
    ol.Observable.prototype.un.call(this.mapViewport, P.Event.EventType.MOUSEMOVE,
    this.mapMouseMoveHandler, this);
...
ol.inherits(P.PlotEdit, ol.Observable);
...
P.PlotEdit.prototype.controlPointMouseDownHandler = function(e){
    ...
    ol.Observable.prototype.on.call(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.controlPointMouseMoveHandler, this);
    ol.Observable.prototype.on.call(this.mapViewport, P.Event.EventType.MOUSEUP, this.controlPointMouseUpHandler, this);
};
...
P.PlotEdit.prototype.controlPointMouseUpHandler = function(e){
    ...
    ol.Observable.prototype.un.call(this.mapViewport, P.Event.EventType.MOUSEUP,
